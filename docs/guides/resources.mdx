...
|---------|------|-----|------------|
| **Cost** | $0/month | $99/month | Custom pricing |
| **Usage Limits** | Development limits | Production ready | Unlimited |
| **Support** | Community | Email + docs | Dedicated support |
| **SLA** | Best effort | 99.9% uptime | 99.99% uptime |
| **Features** | Basic | Advanced | Enterprise + custom |

<Callout type="tip">
Start with the Free tier for development and testing. You can upgrade to Pro or Enterprise when you're ready for production deployment.
</Callout>
...
curl -H "Authorization: Bearer $API_KEY" \
  https://api.ktrlplane.com/v1/resources/res-abc123/logs
```

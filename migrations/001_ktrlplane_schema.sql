...
('00000000-0004-0000-0000-000000000010', 'Konnektr.Graph', 'models/write', 'Create or Update any Model', NOW()),
('00000000-0004-0000-0000-000000000011', 'Konnektr.Graph', 'models/delete', 'Delete any Model', NOW()),
('00000000-0004-0000-0000-000000000012', 'Konnektr.Graph', 'models/*', 'Perform any operation on any Model', NOW()),
('00000000-0004-0000-0000-000000000013', 'Konnektr.Graph', 'query/action', 'Query any Digital Twins Graph', NOW()),
('00000000-0004-0000-0000-000000000014', 'Konnektr.Graph', 'query/*', 'Query any Digital Twins Graph', NOW()),
('00000000-0004-0000-0000-000000000015', 'Konnektr.Graph', 'jobs/imports/read', 'Read any Bulk Import Job', NOW()),
('00000000-0004-0000-0000-000000000016', 'Konnektr.Graph', 'jobs/imports/write', 'Create any Bulk Import Job', NOW()),
('00000000-0004-0000-0000-000000000017', 'Konnektr.Graph', 'jobs/imports/delete', 'Delete any Bulk Import Job', NOW()),
('00000000-0004-0000-0000-000000000018', 'Konnektr.Graph', 'jobs/imports/cancel/action', 'Cancel any Bulk Import Job', NOW()),
('00000000-0004-0000-0000-000000000019', 'Konnektr.Graph', 'jobs/imports/*', 'Perform any operation on any Bulk Import Job', NOW()),
('00000000-0004-0000-0000-000000000022', 'Konnektr.Graph', 'jobs/*', 'Perform any operation on any Job', NOW()),
('00000000-0004-0000-0000-000000000023', 'Konnektr.Graph', 'jobs/deletions/read', 'Read any Bulk Delete Job', NOW()),
('00000000-0004-0000-0000-000000000024', 'Konnektr.Graph', 'jobs/deletions/write', 'Create any Bulk Delete Job', NOW()),
('00000000-0004-0000-0000-000000000025', 'Konnektr.Graph', 'jobs/deletions/delete', 'Delete any Bulk Delete Job', NOW()),
('00000000-0004-0000-0000-000000000026', 'Konnektr.Graph', 'jobs/deletions/cancel/action', 'Cancel any Bulk Delete Job', NOW()),
('00000000-0004-0000-0000-000000000027', 'Konnektr.Graph', 'jobs/deletions/*', 'Perform any operation on any Bulk Delete Job', NOW());
